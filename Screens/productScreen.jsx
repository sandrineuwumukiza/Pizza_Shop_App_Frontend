...
const styles = StyleSheet.create({
  ...
  title: { fontSize: 24, fontWeight: 'bold', padding: 16, textAlign: 'center', backgroundColor: '#4caf50', color: '#fff' },
  ...
  addToCartButton: { backgroundColor: '#4caf50', padding: 10, marginTop: 10, borderRadius: 4, alignItems: 'center' },
